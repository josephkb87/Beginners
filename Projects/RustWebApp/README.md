# Rust WebApp, SolidJS, and Tauri.

In this repository, we will create a Rust Cross-platform desktop Web Application.

We will Create our WebApp using Rust, SolidJS, and Tauri.
